  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 my-10 md:mx-24 lg:mx-36 sm:mx-24 mx-8">
        {ourServices.map(
          ({ id, bgColor, bgImg, title, description, icon, alt, aos }) => {
            return (
              <div
                key={id}
      ...
      {/* <div
        className="my-20 mb-0 rounded-3xl shadow-lg transition-all ease-in-out duration-500 hover:shadow-2xl"
        style={{
          backgroundImage:
            bgImage === "white" ? `url(${none})` : `url(${imageUrl})`,
      ...
      >
        <h1
          className="text-3xl md:text-4xl text-center py-10 font-[700]"
          style={{
        ...
        <h2
          className="text-textWhite font-semibold w-full text-center h-9 text-4xl"
          style={{
